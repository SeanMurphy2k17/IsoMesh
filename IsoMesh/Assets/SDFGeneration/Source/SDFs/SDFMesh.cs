...
namespace IsoMesh
{
    public class SDFMesh : SDFObject
    {
        ...
        [SerializeField]
        [Tooltip("Use original mesh UVs instead of procedural triplanar mapping")]
        private bool m_usePackedUVs = false;
        ...
        // Override GetMaterial to automatically apply UsePackedUVs setting
        public override SDFMaterialGPU GetMaterial()
        {
            var material = Material; // Get the base material
            material.UsePackedUVs = m_usePackedUVs; // Apply our local setting
            return new SDFMaterialGPU(material);
        }
